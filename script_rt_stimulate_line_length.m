...
minutes_to_record = 0.2;
approx_epoch_timelength = 0.2; % 200ms
threshold_value_nf_ll = 0.5;
...
% PROMPT USER:
prompt='Average line_length of the baseline :';
norm_baseline = input(prompt); 
...
% define the realfdata:
% realfdata = reshape(fdata', [1 numel(fdata)]);
