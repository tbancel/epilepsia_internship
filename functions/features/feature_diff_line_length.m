function [features, feature_description] = feature_diff_line_length(epoched_signal)
    % This function return as a feature the derivative (or delta) of the
    % line length, it may be a good feature for onset, ending detection of 
    % seizures
